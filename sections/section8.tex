\section{データベース設計}
本システムのデータベース設計を以下に示す．図 \ref{fig:sec8/er} はデータの関係をER図で表したものであり，表 \ref{tb:user} から表 \ref{tb:report}はデータベースのテーブル設計である．
\begin{figure}[H]
    \centering
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        ...
        postId & ○ & ○ & not null & INT & 投稿ID \\ \hline
        genreName & & & not null & ENUM('food', 'event', 'scene', 'store', 'emergency', 'other') & ジャンル名 \\ \hline
