...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.4]{sections/User_UI/User_UI.jpg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.5]{sections/User_UI/sort.jpg}}
    \caption{並び替え}
    \label{sort}
\end{figure}
...
図\ref{new_post}のように，タイトルを入力し，説明を入れ，図\ref{new_post_genre}のような投稿のジャンル分けをし，画像を挿入できる．地図上でクリックまたは店舗名検索で投稿の位置を指定できる．
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.5]{sections/User_UI/view_posts.jpg}}
    \caption{投稿閲覧画面}
    \label{view_posts}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.5]{sections/User_UI/my_page.jpg}}
    \caption{マイページ画面}
    \label{my_page}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.5]{sections/User_UI/can_application.jpg}}
    \caption{事業者登録申請後}
