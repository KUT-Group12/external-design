...
\begin{figure}[H]
    \centering
    \fbox{\includesvg[scale=0.4]{sections/User_UI/User_UI.svg}}
...
閲覧できる内容は図\ref{view_posts}のように，タイトル，ジャンル，投稿者（投稿者が一般会員なら匿名，事業者会員なら事業者会員の名前），投稿日時，閲覧数，説明，投稿場所の座標，リアクション数である．また，一般会員はリアクションとブロックをすることができる．
