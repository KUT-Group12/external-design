...
\begin{figure}[H]
    \centering
    \fbox{\includesvg[scale=0.5]{sections/User_UI/User_UI.svg}}
...
閲覧できる内容は図\ref{view_posts}のように，タイトル，ジャンル，投稿者（投稿者が一般会員なら匿名，事業者会員なら事業者会員の名前），投稿日時，閲覧数，説明，投稿場所の座標，リアクション数である．また，一般会員はリアクションをすることができる．利用者はブロックと同じ場所に投稿を追加することができる．投稿を追加する場合は新規投稿画面へ画面が遷移する．
...
図\ref{inquiry}のようにお問い合わせの件名，お問い合わせ内容を記入し，「送信する」を押すと図\ref{after_inquiry}のように「お問い合わせを送信しました．運営からの返信をお待ちください」と表示される．お問い合わせの件名，お問い合わせ内容を記入されてない場合「送信する」を押すことができない．「キャンセル」を押すとお問い合わせ画面に遷移する前の画面へ戻る．
