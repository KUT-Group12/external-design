...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{sections/Administrator_UI/administrator.pdf}
    \caption{管理者全体の画面遷移図}
...
通報管理画面では，図\ref{report_management}のように管理者が任意のタイミングで通報された投稿を削除することができる．「投稿削除」ボタンを押すと\ref{after_report_management}のように投稿を削除することができる．
...
投稿管理画面では図\ref{post_management}のように，投稿を管理することができる．ゴミ箱のボタンを押すと図\ref{after_post_management}のように投稿を削除することができる．
