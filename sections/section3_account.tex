...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_account_general/account_gen2_1.svg}
    \caption{ログイン}
    %\label{Business_screen_transition_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_account_general/account_gen2_2.svg}
    \caption{ログアウト}
    %\label{Business_screen_transition_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_account_general/account_gen3.svg}
    \caption{退会}
    %\label{Business_screen_transition_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_account_general/account_gen4.svg}
    \caption{問い合わせ}
    %\label{Business_screen_transition_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_account_general/account_gen5.svg}
    \caption{事業者申請機能}
    %\label{Business_screen_transition_diagram}
\end{figure}
