...
ユーザー管理タブを選択すると，ユーザー一覧を格納しているデータベースにアクセスし，ユーザー一覧を表示する．右側にあるゴミ箱ボタンを押すことで該当するユーザーとその投稿とリアクションを全て削除する．削除後に，「削除しました」というポップが表示される．
...
問い合わせタブを選択すると，問い合わせ情報を格納しているデータベースにアクセスし，未対応の問い合わせ情報のみを表示する．そこから返信ボタンを押し，返信をすることでそれをユーザーに送信すると共に該当の問い合わせを対応済みに変更し，「対応済みにしました」というポップを表示する．
