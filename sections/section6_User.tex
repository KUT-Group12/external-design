...
図\ref{new_post}のように，タイトルを入力し，説明を入れ，図\ref{new_post_genre}のような投稿のジャンル分けをすることができる．また，任意で画像を添付することもできる．地図上でクリックまたは事業者名検索で投稿の位置を指定できる．
...
「事業者登録申請」ボタンを押すと，事業者会員になるための申請をすることができる．
...
「投稿履歴」ボタンを押すと，図\ref{post_history}のように一般会員が投稿した履歴を確認することができる．
「削除」というボタンを押すと図\ref{delete_post}のように「この投稿を削除しますか」と表示され「OK」を押すと投稿を削除することができる．
「リアクション履歴」ボタンを押すと，図\ref{reaction_history}のように一般会員がリアクションした投稿を閲覧できる．
「設定」ボタンを押すと，図\ref{setting}のようにブロックしたユーザーの管理，退会画面へのボタンを押すことができる．
...
図\ref{User_inquiry}のようにお問い合わせの件名，お問い合わせ内容を記入し，「送信する」を押すと図\ref{after_inquiry}のように「お問い合わせを送信しました。運営からの返信をお待ちください。」と表示される．お問い合わせの件名，お問い合わせ内容が記入されてない場合「送信する」を押すことができない．「キャンセル」を押すとお問い合わせ画面に遷移する前の画面へ戻る．
