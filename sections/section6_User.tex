...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{sections/User_UI/User_UI.pdf}
...
閲覧できる内容は図\ref{view_posts}のように，タイトル，ジャンル，投稿者（投稿者が一般会員なら匿名，事業者会員なら事業者会員のユーザー名），投稿日時，閲覧数，説明，投稿場所の座標，リアクション数である．また，一般会員はリアクションをすることができる．利用者はブロック，同じ場所に投稿を追加することができる．投稿を追加する場合は新規投稿画面へ画面が遷移する．
