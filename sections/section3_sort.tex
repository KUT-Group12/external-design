...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_sort_general/sort_gen1.svg}
    \caption{距離順}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_sort_general/sort_gen2.svg}
    \caption{リアクション数順}
    %\label{administrator_screen_transition_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_sort_general/sort_gen3.svg}
    \caption{新着順}
    %\label{administrator_screen_transition_diagram}
\end{figure}