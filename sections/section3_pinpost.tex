...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen1_1.jpg}
    \caption{場所情報投稿機能の全体}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen1_2.jpg}
    \caption{投稿を取りやめる}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen1_3.jpg}
    \caption{位置情報を地図表で選択}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen1_4.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen2.jpg}
    \caption{記述・写真情報投稿機能}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen3.jpg}
    \caption{時間情報登録機能}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen4.jpg}
    \caption{ジャンル登録機能}
...
一般会員が閲覧画面に表示されているピンを選択すると，そのピンに投稿されている内容が表示される．「投稿を追加」を選択すると投稿画面が表示される．投稿内容を入力して，「投稿する」を選択すると必須入力であるタイトル，説明，緯度，経度が入力されているかを確認して入力されていない項目があれば，「このフィールドを入力してください」と表示する．投稿する条件を満たしているならば，データベースにアクセスして投稿内容を格納する．その際に，ピンに対する投稿数を1増やす．ピンに対する投稿数が50以上ならばピンの大きさを通常より大きくして表示するようにする．

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{sections/fig_pinpost_general/pinpost_gen5.jpg}
    \caption{投稿追加機能}
